...
return (
    <div className='flex flex-col items-center mt-[108px]'>
        <h2 className='text-3xl font-semibold mt-10 mb-6'>Готовые наборы</h2>
        ...
        <button className='mb-[80px] mt-[35px] px-[48px] py-[18px] border border-[#4E9DD3] text-sm font-semibold hover:text-white hover:bg-[#4E9DD3] transition-all'>Все праздничные наборы</button>
    </div>
  )
}
